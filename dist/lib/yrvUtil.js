...
var _yrvObservable = require("./yrvObservable");

var _yrvObservable2 = _interopRequireDefault(_yrvObservable);
...
var YrvUtil = function () {
    ...
    _createClass(YrvUtil, null, [{
        ...
        value: function receiveRvEvent(rvEventName, callback) {
            document.addEventListener("rv_" + rvEventName + "_" + YrvUtil.getHashCode(rvEventName), function (e) {
                callback(e, e.detail);
            });
        }
    }, {
            ...
            if (obj) {
                ...
                Object.keys(obj).forEach(function (key) {
                    if (getType(obj[key]) == "obj") {
                        if (key === "componentMap") {
                            var newComponentMap = new _yrvMap2.default(obj[key].name + "_clone");
        ...
        value: function observe(obj, observeMap, callback) {
            Object.keys(obj).forEach(function (key) {
                ...
                var observable = new _yrvObservable2.default();
