...
RV组件构造函数形参componentParam对象属性onRun 为RV组件方法，组件运行时候触发
RV组件构造函数形参componentParam对象属性onDomChange为RV组件方法，dom变化时触发
RV组件构造函数形参componentParam对象属性onMount为RV组件方法，组件挂载时触发
